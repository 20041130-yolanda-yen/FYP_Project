...
public class Location extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                output_text.setText("Car num: " + output + "\n\n"
                        ...
                        + "Approved location: " + approvedLocation
                );
        ...
        Task<Text> result = textRecognition.process(image).addOnSuccessListener(new OnSuccessListener<Text>() {
            ...
            public void onSuccess(Text visionText) {
                ...
                if (m.find()) {
                    ...
                    Toast.makeText(Location.this, "Detected: " + text, Toast.LENGTH_LONG).show();
                }
                updateUI();
            }
    ...
    private void verifyData(String car_num) {
        firebaseDataHelper = new FirebaseDataHelper(Location.this);
        ...
        if (firebaseData1 != null) {
            ...
            approvedLocation = getApprovedLocation(occ, cpType);
            if (approvedLocation.equals("Car parks 1 & 4")) {
                if (!carpark.equals("P1") && !carpark.equals("P4")) {
                    approvedLocation += "\n Vehicle is not allowed to park here: " + carpark;
                    result = "Not approved";
                } else {
                    result = "Approved";
                }
            }
            else if (approvedLocation.equals("Car parks 1,3,4")) {
            ...
            else if (approvedLocation.equals("Car parks 1,4,5")) {
            ...
            approvedLocation += "\n Vehicle is approved by RP";
            result = "Not approved";
        }

        output_text.setVisibility(View.VISIBLE);
        updateUI();
        updateSQL(TYPE, output, carpark,result);
    }
    ...
    private void updateSQL(String TYPE, String carNum, String location, String result) {
        ...
        ScannedVehiclesHelper databasehelper = new ScannedVehiclesHelper(Location.this);
    ...
    private void showDialog(String title){
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Location.this,
        ...
        mBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!sp1.getSelectedItem().toString().equals("Edit location")) {
                    ...
                    Toast.makeText(Location.this, "You have selected: " + carpark, Toast.LENGTH_SHORT).show();
                    locationManager.removeUpdates(listener);
                    updateUI();
                    dialog.dismiss();
                } else{
                    Toast.makeText(Location.this, "No location change.", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
            }
        });
